...
class oboardDetectorProcessor():
    ...
    def init_patch_engine(self, x):
        ...
        self.x_coreg_pad=pad(x, (0, (256 - (x.shape[2] - n_h * 256)) % 256, 0, (256 - (x.shape[1] - n_v * 256) % 256)), "replicate")
        self.h=0
        self.v=0
        self.finished=False
    ...
    def process(self, x):
        ...
        if self.ai_model is None:
            raise ValueError("No model loaded. You need to specify a model before start the processing.")
